        ...
        <main>
            <footer id="footer" className="bg-teal-700 text-white text-xl">
                <section className="max-w-4xl mx-auto flex flex-col sm:flex-row sm:justify-between">
                    ...
                    Email: <a href="mailto:inquiries@acmerockets.com">Inquires@AcmeRockets.com</a><br></br>
                    ...
                    <div className="flex flex-col sm:gap-2"><p className="text-right">Copyright &copy; <span id="year">2023
                    </span></p>
