            ...
            <section id="testimonials" className="p-6 my-12 scroll-mt-20 widescreen:section-min-height tallscreen:section-min-height">
                ...
                <figure className='my-12 '>
                    <blockquote className="bg-teal-600 dark:bg-black pl-14 pr-8 py-12 rounded-3xl relative">
                        <p className="text-2xl sm:text-3xl text-left mt-2 text-white dark:text-slate-400 before:content-['\201C'] before:font-serif before:absolute 
                        before:top-0 before:left-0 before:text-9xl before:text-white before:opacity-25 before:transform before:translate-x-2 before:translate-y-2 
                        after:content-['\201D'] after:font-serif after:absolute after:-bottom-15 after:right-10 after:text-9xl after:text-white after:opacity-25 
                    ...
                    <figcaption className='italic text-xl sm:text-2xl text-right mt-2 text-slate-500 dark:text-slate-400'>&#8212;Wile E. Coyote, Genius</figcaption>
                </figure>
                <figure className='my-12 '>
                    <blockquote className="bg-teal-600 dark:bg-black pl-14 pr-8 py-12 rounded-3xl relative">
                        <p className="text-2xl sm:text-3xl text-left mt-2 text-white dark:text-slate-400 before:content-['\201C'] before:font-serif before:absolute 
                    ...
                    <figcaption className='italic text-xl sm:text-2xl text-right mt-2 text-slate-500 dark:text-slate-400'> &#8212;Marvin The Martian &amp; K-9</figcaption>
                </figure>
                <figure className='my-12 '>
                    <blockquote className="bg-teal-600 dark:bg-black pl-14 pr-8 py-12 rounded-3xl relative">
                        <p className="text-2xl sm:text-3xl text-left mt-2 text-white dark:text-slate-400 before:content-['\201C'] before:font-serif before:absolute 
                    ...
                    <figcaption className='italic text-xl sm:text-2xl text-right mt-2 text-slate-500 dark:text-slate-400'>   &#8212;Buzz Lightyear</figcaption>
                </figure>
            </section>
